...
namespace common {
    ...
    std::string commandTypeToString(CommandType type) {
        ...
        case CommandType::CreateGroup: return "create_group";
        case CommandType::CreateGroupResult: return "create_group_result";
        case CommandType::GetGroupInfo: return "get_group_info";
        case CommandType::GroupMemberItem: return "group_member_item";
        case CommandType::GroupInfoResult: return "group_info_result";
        case CommandType::AddGroupMembers: return "add_group_members";
        case CommandType::RemoveGroupMember: return "remove_group_member";
        case CommandType::TransferGroupAdmin: return "transfer_group_admin";
        case CommandType::LeaveGroup: return "leave_group";
        case CommandType::DeleteGroup: return "delete_group";
        case CommandType::GroupUpdateResult: return "group_update_result";
        case CommandType::ChatRemoved: return "chat_removed";
    ...
    CommandType commandTypeFromString(const std::string& value) {
        ...
        if (value == "create_group") return CommandType::CreateGroup;
        if (value == "create_group_result") return CommandType::CreateGroupResult;
        if (value == "get_group_info") return CommandType::GetGroupInfo;
        if (value == "group_member_item") return CommandType::GroupMemberItem;
        if (value == "group_info_result") return CommandType::GroupInfoResult;
        if (value == "add_group_members") return CommandType::AddGroupMembers;
        if (value == "remove_group_member") return CommandType::RemoveGroupMember;
        if (value == "transfer_group_admin") return CommandType::TransferGroupAdmin;
        if (value == "leave_group") return CommandType::LeaveGroup;
        if (value == "delete_group") return CommandType::DeleteGroup;
        if (value == "group_update_result") return CommandType::GroupUpdateResult;
        if (value == "chat_removed") return CommandType::ChatRemoved;
